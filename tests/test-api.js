define([
  ...
  'errors',
  'settings'
], function(apiModule, fxpay, helper, errors, settings) {
  ...
  describe('fxpay.API()', function () {
    ...
    it('should send the library version with each request', function (done) {
      helper.server.respondWith(
        'GET', /.*/,
        function(request) {
          assert.ok(settings.libVersion);  // make sure it's defined.
    ...
    it('should report XHR abort', function (done) {
      ...
      api.post('/some/path', null, function(err) {
        assert.instanceOf(err, errors.ApiRequestAborted);
        done();
      });
    ...
    it('should report XHR errors', function (done) {
      ...
      api.post('/some/path', null, function(err) {
        assert.instanceOf(err, errors.ApiRequestError);
        done();
      });
    ...
    it('should report unparsable JSON', function (done) {
      ...
      api.post('/some/path', null, function(err) {
        assert.instanceOf(err, errors.BadJsonResponse);
        done();
      });
    ...
    it('should timeout', function (done) {
      ...
      api.post('/timeout', null, function(err) {
        assert.instanceOf(err, errors.ApiRequestTimeout);
        done();
      });
